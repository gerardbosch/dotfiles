...
#  If so, run ./CWD/os/client-script-name, e.g. ./_linux/fol, all protected by an exist file -f guard or exists and executable
#
#  Then move all dotfile-linux bin/keyboard-triggers in here ./_linux and make the outer script
...
dispatch() {
  ...
  # Dispatch passing original arguments as directory "_OS", e.g. "_linux"
  ${cwd}/_${os}/${programName} "$@"
}
